...
## ROTATING THE GAMMAR FUNCTIONS: Elements of the DECORR matrix & needed in the data vector

i = 0
while i<len(n): 
    rot_m_array = rotation_pix(m_array,n[i])    #this is the rotated array; let's pretend counter-rotation is just inverting the order of the elements. now one simply does
